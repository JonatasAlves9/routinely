    ...
    return (
        ...
        >
            ...
            <div className='fv-row mb-8'>
                ...
                <label className='form-label fw-bolder text-dark fs-6'>Segundo nome</label>
                <input
            ...
            <div className='fv-row mb-5'>
                <label className='form-label fw-bolder text-dark fs-6'>Confime sua senha</label>
                <input
                    type='password'
